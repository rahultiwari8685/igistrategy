    ...
    return (
        ...
        >
            <CCol xs={12} sm={10} md={8} lg={6}>
                <CCard className="shadow-lg border-0" style={{ borderRadius: '1.5rem', backgroundColor: 'rgba(255, 255, 255, 0.9)' }}>
                    <CCardHeader className="text-white text-center bg-dark" style={{ borderTopLeftRadius: '1.5rem', borderTopRightRadius: '1.5rem' }}>
                        <h4 className="my-2">
                    ...
                    <CCardBody className="p-4">
                        <CForm onSubmit={handleSubmit}>
                            {/* Old Password */}
                            <div className="mb-4">
                                <CFormLabel htmlFor="oldPassword" className=" fw-bold">Old Password</CFormLabel>
                                <CInputGroup>
                                    <CFormInput
                            ...
                            {/* New Password */}
                            <div className="mb-4">
                                <CFormLabel htmlFor="newPassword" className=" fw-bold">New Password</CFormLabel>
                                <CInputGroup>
                                    <CFormInput
                            ...
                            {/* Confirm Password */}
                            <div className="mb-4">
                                <CFormLabel htmlFor="confirmPassword" className=" fw-bold">Confirm Password</CFormLabel>
                                <CInputGroup>
                                    <CFormInput
