            ...
            <div className="container">
                <div className="pages_heder">
                    ...
                    <ol className="breadcrumb">
                        ...
                        <li><a href="register.html" className="active">Register</a></li>
                    </ol>
                </div>
            </div>
                ...
                <div className="container">
                    <div className="login_inner">
                        <form className="row login_from">
                            ...
                            <div className="form-group col-12">
                                <input type="password" className="form-control" name="password" placeholder="Confarm Password" />
                            </div>
                            <div className="form-group larg_btn col-12">
                                <button className="defult_btn" type="submit">Register</button>
                            </div>
