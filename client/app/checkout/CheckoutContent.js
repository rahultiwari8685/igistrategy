...
export default function CheckoutContent() {
  ...
  useEffect(() => {
    ...
    const loadPlan = async () => {
      try {
        const res = await fetch(`${setting.api}/api/plans/${planId}`);
  ...
  const handlePayment = async () => {
    try {
      ...
      const res = await fetch(`${setting.api}/api/payments/create-order`, {
        method: "POST",
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-gray-600">Review your plan before payment</p>
          </div>
